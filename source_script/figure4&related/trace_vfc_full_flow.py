...
JOINT_TAX_FILE = "/home/huangyan/experiment/SPA/3/gut_isolate/prophage/analysis/3_prophage_stats/sig_act_prevalence/VFC_cluster/clustering_results/viral_with_vfc_taxonomy.csv"
VFC_META_FILE = "/home/huangyan/experiment/SPA/3/gut_isolate/prophage/analysis/3_prophage_stats/sig_act_prevalence/VFC_cluster/clustering_results/vfc_votu.tsv"
...
EXACT_STATS_FILE = "/home/huangyan/experiment/SPA/3/gut_isolate/prophage/analysis/3_prophage_stats/allpp_taxonomy/active_tax_new_20260511/MH_test/stats_baseline_vOTU_EXACT.tsv"
...
OUTPUT_FILE = "vfc_full_flow_breakdown_exact.tsv"
...
def main():
    ...
    # Exact test results
    df_stats = pd.read_csv(EXACT_STATS_FILE, sep='\t')
    votu_sig_map = pd.Series(df_stats.Significance_Type.values, index=df_stats.vOTU).to_dict()
    ...
    print(df_final[['VFC_Source', 'Target_vFAM', 'Flow_Percentage', 'User_vOTU_Total', 'User_Significant_Count']].head(10).to_string())
